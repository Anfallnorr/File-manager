...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $lang ?>" lang="<?php echo $lang ?>">
		...
		<body requests="" theme="<?php echo $theme ?>" bgtheme="bg-<?php echo $themeBg ?>" class="hidden-x bg-theme <?php echo $this->requests->view ?>-page <?php echo $this->requests->controller .'-'. $this->requests->view; ?>">
			<div class="wrapper">
