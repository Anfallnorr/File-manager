...
<script src="/templates/<?php echo $theme ?>/html/datas/assets/js/ajax-dropzone.js" type="text/javascript"></script>
<script src="/templates/<?php echo $theme ?>/html/datas/assets/js/data.js" type="text/javascript"></script>
