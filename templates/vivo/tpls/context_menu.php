...
<div id="context_menu" class="card radius-10 overflow-hidden context-menu context-menu-normal">
	...
	<ul class="list-group list-group-flush context-menu__items">
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="add"><i class="bi bi-plus-square-dotted fs-16"></i> ADD_NEW</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="download"><i class="bi bi-download fs-16"></i> Télécharger</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="zip"><i class="bi bi-file-earmark-zip fs-16"></i> Compresser</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="unzip"><i class="bi bi-folder-check fs-16"></i> Décompresser</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="move"><i class="bi bi-arrows-move fs-16"></i> Déplacer</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="rename"><i class="bi bi-input-cursor-text fs-16"></i> Renomer</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
		...
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="share"><i class="bi bi-share fs-16"></i> Partager</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="approve"><i class="bi bi-calendar2-check fs-16"></i> APPROVE</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
		...
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="logascustomer"><i class="bi bi-door-open fs-16"></i> LOGASCUSTOMER</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
			<a href="#" class="context-menu__link" context-action="cleanFile"><i class="bi bi-file-earmark-excel fs-16"></i> CLEANFILE</a>
		</li>
		<li class="list-group-item list-group-item-light list-group-item-action context-menu__item">
		...
		<div class="d-flex">
			<div class="btn-group dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li class="dropdown-item context-menu__item">
						<a href="#" class="context-menu__link" context-action="massActivate"><i class="bi bi-check2-all fs-16"></i> MASS_ACTIVATE</a>
					</li>
					<li class="dropdown-item context-menu__item">
						<a href="#" class="context-menu__link" context-action="massDeactivate"><i class="bi bi-x-lg fs-16"></i> MASS_DEACTIVATE</a>
					</li>
					<li class="dropdown-item context-menu__item">
						<a href="#" class="context-menu__link" context-action="massSwitchState"><i class="bi bi-intersect fs-16"></i> MASS_SWITCH_STATE</a>
					</li>
					<li class="dropdown-item context-menu__item">
